...
class FindTools {
  static Future<RMUser?> findUserWithCardNum(String cardNumber) async {
  ...
  static Future<RMUser?> findUserWithUID(String uid) async {
    final matchingDoc =
  ...
  static Future<List<RMUser>> findUsersWithUID(
